...
//import com.jlkj.web.exception.SmsSendException;
//import com.jlkj.web.utils.redis.RedisUtil;
//
...
//	 * 判断当前手机是否允许发送验证码
//	 */
//	public static void checkSendPermission(String mobile  ,RedisUtil redisUtil) throws SmsSendException {
//
//		//首先检查距上次发送的进间是否在一分钟之内
//		if( redisUtil.exist( mobile + ".lastsendflag" ) ){
//			throw new SmsSendException(Errors.SmsError.smsSendIntervalTooShort) ;
//		}
//
//		Set set = redisUtil.keys(mobile + ".lastonehour." + "*") ;
//		//在1小时内的最多发送20次
//		if( set != null && set.size() > 20){
//			throw new SmsSendException(Errors.SmsError.smsSendTimesTooMany) ;
//		}
//	}
//
