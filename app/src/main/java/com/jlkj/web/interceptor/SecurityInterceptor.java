//package com.jlkj.web.interceptor;
//
...
//
//import com.jlkj.web.apppay.enums.Platform;
//import com.jlkj.web.core.ResponseResult;
//import com.jlkj.web.exception.BussinessException;
//import com.jlkj.web.exception.ErrorObject;
//import com.jlkj.web.exception.Errors;
//import com.jlkj.web.utils.ErrorUtil;
...
//				throw new BussinessException(Errors.commonError.headerParamsEmptyException);
//			}
//			// 判断platform输入是否正确
//			if (mobilePlatformCache.get(platform) == null) {
//				throw new BussinessException(Errors.commonError.platformParamCheckException);
//			}
//			// 判断token是否为空
//			if (StringUtils.isNotBlank(token)) {
//				// 如果token不存在则抛出异常
////				if (!sessionUtil.existLoginToken(token)) {
////					throw new BussinessException(Errors.commonError.tokenNotExistException);
////				} else { // 重置token的超时时间
